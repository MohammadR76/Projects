...
Folder ([Statistics/Descriptive Statistics](https://github.com/MohammadR76/Projects/tree/main/Statistics/Descriptive%20Statistics)) is dedicated to descriptive statistics and includes the following:
- Data analysis using descriptive measures such as mean, median, mode, variance, standard deviation, skewness, and kurtosis
- Correlation analysis using Pearson, Spearman, and Kendall coefficients
- Analysis of data distributions including normal, uniform, Bernoulli, binomial, multinomial, and Poisson distributions
- Examination of distributions based on probability density functions (PDF) and cumulative distribution functions (CDF)
- Comparison of distributions using Kullback–Leibler divergence and Jensen–Shannon divergence


## 2. Preprocessing
Folder ([Preprocessing](https://github.com/MohammadR76/Projects/tree/main/Preprocessing)) is dedicated to data preprocessing and includes the following:
